...
public class ConfigFile {
    ...
    public static String getPath() {
        ...
        try {
            try {
                return (MinecraftClient.getInstance().getServer().getRunDirectory().toAbsolutePath()+"/saves/"+
                        (
                                (MinecraftClient.getInstance().getServer().getSavePath(WorldSavePath.ROOT).toString())
                                        .replace(MinecraftClient.getInstance().getServer().getRunDirectory().toAbsolutePath()+"/saves/", "")
