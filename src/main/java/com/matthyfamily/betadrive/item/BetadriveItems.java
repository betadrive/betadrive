...
public class BetadriveItems {
    ...
    public static void init() {
        ...
        Registry.register(Registry.ITEM, new Identifier("betadrive", "android_spawn_egg"), new SpawnEggItem(BetadriveEntities.ANDROID, 0xFFFFFF, 0xCCCCCC, new Item.Settings().group(ItemGroup.MISC)));
    }
}
